# 这个程序专门测试你编写的ps3程序是否符合要求的---程序
# Test code for ps3.py
# 单元测试：只保留相应测试函数代码，其余代码可以通过块注释加以屏蔽
# 

from ps3_Code_show import * 
# Combine into a program with ps3
# TeacherCode,using name ps3_Code_show instead of ps3
# you should rename to your Python file name of PS3
...
## main code to test PS3.py/PS3_Code_Show.py
